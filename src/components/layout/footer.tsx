        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your trusted multi-product ecommerce platform offering quality products 
              with seamless shopping experience and reliable service.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@dropshop.com</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2025 DropShop. All rights reserved.
            </p>
